...
| 3 | [Mapping data flows copy](#3data-flows-copy) |

## 1. Stage data in the data lake

Data was staged as part of the setup for this lab. See <a href="../modules/module00.md/#stage-module-3-two-ways-to-do-a-basic-copy-sample-data">staging instructions</a> for more information.
...
1. In the **Properties** pane of the new pipeline, add a **Name** and **Description**.
...
1. From the **Activities** pane, under **Move & transform**, click and drag the **Copy data** activity into the pipeline area. Then, on the **Source** tab of the activity properties, click the **+ New** button.

   <kbd> <img src="../images/module03/new_dataset.png" alt="New dataset" /> </kbd>

1. In the **New dataset** pane, find **Azure Data Lake Storage Gen 2** and click the **Continue** button.
...
1. Click the **Open** button from the **Source** tab of the **Copy data** activity properties.

   <kbd> <img src="../images/module03/open_dataset_adls.png" alt="New dataset adls 2" /> </kbd>

1. On the **Parameters** tab of the new dataset, click the **+ New** button and add three parameters.
...
1. Click the `ds_ir_azure_adls_binary` dataset elipsis menu item and select **Clone**.

   <kbd> <img src="../images/module03/clone_adls_dataset.png" alt="Clone dataset" /> </kbd>

1. On the **Properties** pane of the cloned dataset, replace the text "copy1" in the **Name** with `directory`. The name of the dataset should now be `ds_irazure_adls_binary_directory`.
...
1. Click the `pl_simple_copy` pipeline from the list of Pipelines. On the **Source** tab of the **Copy data** activity, enter the following values. 
...
1. On the **Sink** tab of the **Copy data** activity, enter the following values. 
...
1. Click the **Debug** button and ensure your copy succeeds!
...
1. From the **Activities** pane, under **Move & transform**, click and drag the **Data flow** activity into the pipeline area. Then, on the **Settings** tab, click the **+ New** button.
...
1. On the Properties pane, enter the following values.
...
1. Click the **Data flow debug** radio toggle from within the data flows working area. Select the **Integration runtime** `ir-vnetwork-medium-60min`. Select `4 hours` from the **Debug time to live** option so that your debug Apache cluster will be available during the next 4 hours of the lab. Click **OK**. 

   <kbd> <img src="../images/module03/df_debug_start.png" alt="Create data flow debug cluster" /> </kbd>

1. Click the **Add Source** option from the down caret menu as shown below.
...
1. On the **Source options** tab, click the `Wildcard` **File mode** option and click the **Browse** button. 
    ...
    1. On the **Edit integration runtime** pane, on the **Virtual network** tab, click **Enable** under **Interactive authoring**. Then, click **Apply**.

        <kbd> <img src="../images/module03/edit_interactive_authoring2.png" alt="DF Interactive authoring" /> </kbd>

    1. When the runtime is edited to allow interactive authoring, the **Browse** pane will indicate `Interactive authoring enabled`. Click **Retry**.

        <kbd> <img src="../images/module03/edit_interactive_authoring3.png" alt="DF Interactive authoring" /> </kbd>

1. Use the **Browse** pane to navigate to `inbound` and click **OK**. The **File system** and **Wildcard paths** container values will show `inbound`.

   <kbd> <img src="../images/module03/df_source_browse.png" alt="DF Source browse" /> </kbd>

1. Enter `nyx_taxi_sample/*.parquet` in the **Wildcard paths** field as shown below.

   <kbd> <img src="../images/module03/df_source_settings2.png" alt="DF Source options path" /> </kbd>

1. On the **Projection** tab, click **Import schema**.

   <kbd> <img src="../images/module03/df_projection.png" alt="DF Source options path" /> </kbd>

1. On the **Data preview** tab, click **Refresh** to see a preview of the data. Data flow activity data previews are used in conjunction with sampling of the source data to allow for ease of development and to ensure the Azure Data Factory user interface is able to pre-populate the data mid-transformation.

   <kbd> <img src="../images/module03/df_source_preview.png" alt="DF Source preview" /> </kbd>

1. Click the **+** button on the bottom right corner of the `source` activity and then select the **Sink** option.

   <kbd> <img src="../images/module03/df_add_sink.png" alt="DF Sink Add" /> </kbd>

1. Enter the following values in the **Sink** tab.
...
1. On the **Settings** tab, click the **Browse** button, browse to `publish/nyx_taxi_sample_dataflow` and click **OK**.

   <kbd> <img src="../images/module03/df_sink_settings.png" alt="DF Sink Settings" /> </kbd>

1. Set the unmask settings as shown below.
...
1. On the **Data preview** tab, click **Refresh** to see a preview of the data.

   <kbd> <img src="../images/module03/df_sink_refresh.png" alt="DF Sink Refresh" /> </kbd>

1. Click the `pl_simple_copy_df` pipeline from the list of **Pipelines**.  Click the **Debug** button and ensure your copy succeeds!
    ...
    - If you get an message prompting you to select whether to use the activity runtime or the debug session, click `Continue with debug session` to ensure you are using the Spark capability of data flows.
         ...
         <kbd> <img src="../images/module03/select_dataflow_runtime.png" alt="DF Debug" /> </kbd>
