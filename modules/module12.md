...
<div align="right"><a href="#module-12---SAP CDC ADF setup">↥ back to top</a></div>
...
<kbd> <img src="../images/module12/overview_of_ETL.png" alt="Overview of SAP CDC to ADF" /> </kbd>
...
<kbd> <img src="../images/module12/SHIR_6.png" alt="SHIR" /> </kbd>
<kbd> <img src="../images/module12/SHIR_7.png" alt="SHIR" /> </kbd>
...
<kbd> <img src="../images/module12/SHIR_8.png" alt="SHIR" /> </kbd>
...
<kbd> <img src="../images/module12/LINKSRV1.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/LINKSRV2.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/LINKSRV3.png" alt="LINKSRV" /> </kbd>

Use type **SAP CDC**

<kbd> <img src="../images/module12/LINKSRV4.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/LINKSRV5.png" alt="LINKSRV" /> </kbd>

2.3.2 Once the Dataset is created, you can verify the connection using **Test connection**
<kbd> <img src="../images/module12/LINKSRV6.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/Create_ADLS.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/Create_SQL_Pool.png" alt="LINKSRV" /> </kbd>

2.4.2 Create SQL Table schema in synapse.
<kbd> <img src="../images/module12/Create_SQL_Table.png" alt="LINKSRV" /> </kbd>

2.4.3 Grant ADF Useracess to synpase workspace.
<kbd> <img src="../images/module12/Grant_ADF_access.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/LINKSRV7.png" alt="LINKSRV" /> </kbd>

2.4.5 Provide the details of the Synapse SQL Pool that will be used as the Target.
<kbd> <img src="../images/module12/LINKSRV8.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE2.png" alt="LINKSRV" /> </kbd>

2.6.3 In the General tab change the **name** 
<kbd> <img src="../images/module12/PIPELINE3.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE4.png" alt="LINKSRV" /> </kbd>

2.6.5 Create a new Dataflow
<kbd> <img src="../images/module12/PIPELINE5.png" alt="LINKSRV" /> </kbd>

In the Dataflow, **Add Source**
<kbd> <img src="../images/module12/PIPELINE6.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE7.png" alt="LINKSRV" /> </kbd>

Enable **Data flow debug**

<kbd> <img src="../images/module12/Debug_On.png" alt="LINKSRV" /> </kbd>

2.6.6 In Source options:
Key Columns: SALESDOCUMENT (Use the Refresh button)

<kbd> <img src="../images/module12/PIPELINE8.png" alt="LINKSRV" /> </kbd>

In **Projection**, select **Import projection**
<kbd> <img src="../images/module12/PIPELINE9.png" alt="LINKSRV" /> </kbd>

## Add some simple transformations

<kbd> <img src="../images/module12/PIPELINE10.png" alt="LINKSRV" /> </kbd>
...
Add Derived Columns with the following information:
   ...
   <kbd> <img src="../images/module12/PIPELINE11.png" alt="LINKSRV" /> </kbd>

Use the + button to be able to add a next step to the dataflow.

2.6.8 Select **Sink**
   <kbd> <img src="../images/module12/PIPELINE12.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE13.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE14.png" alt="LINKSRV" /> </kbd>

2.6.10 In the Mapping tab, uncheck **Auto mapping**

<kbd> <img src="../images/module12/PIPELINE15.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/PIPELINE16.png" alt="LINKSRV" /> </kbd>
<kbd> <img src="../images/module12/PIPELINE17.png" alt="LINKSRV" /> </kbd>

3.1.2 Trigger data extraction
<kbd> <img src="../images/module12/EXTRAKT1.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT2.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT3.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT4.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT5.png" alt="LINKSRV" /> </kbd>

<kbd> <img src="../images/module12/EXTRAKT6.png" alt="LINKSRV" /> </kbd>

3.1.5 Verify the extracted data in Synapse using SQL. In the **Develop** view create an SQL query.

<kbd> <img src="../images/module12/EXTRAKT7.png" alt="LINKSRV" /> </kbd>

## 3.2 Extract data - delta changes 

3.2.1 Verify the Purchaseorderbycustomer for the Sales Document # 50 before the change.
<kbd> <img src="../images/module12/EXTRAKT8.png" alt="LINKSRV" /> </kbd>

3.2.2 On SAP, change the **custref** number for this Sales Document # 50
<kbd> <img src="../images/module12/EXTRAKT9.png" alt="LINKSRV" /> </kbd>

3.2.3 Trigger the pipeline run on ADF
<kbd> <img src="../images/module12/EXTRAKT10.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT12.png" alt="LINKSRV" /> </kbd>

**ExtractSalesOrderHeadersUp** - results shows a

`Total # of rows calculated : 1`

<kbd> <img src="../images/module12/EXTRAKT13.png" alt="LINKSRV" /> </kbd>

**SyncSalesOrderHeaders** - results shows a

`Total # of rows calculated : 1`

<kbd> <img src="../images/module12/EXTRAKT14.png" alt="LINKSRV" /> </kbd>

3.2.5 Verify the extracted data in Synapse using SQL. In the **Develop** view create an SQL query.
<kbd> <img src="../images/module12/PIPELINE18.png" alt="LINKSRV" /> </kbd>
...
<kbd> <img src="../images/module12/EXTRAKT15.png" alt="LINKSRV" /> </kbd>
